...
class Particle_filter_smoother():
    ...
    def step_0(self, Y_0, theta):

        C_tp, w_tind, R_0_beta_1, R_0 = self.proposal_epidemic.proposal_epidemic_0(Y_0, theta)
        ...
        return C_tp, A_t, log_p_y_t_given_y_1_to_tm1, R_0_beta_1, R_0
    ...
    def step_t(self, t, theta, C_tp, A_t, Y_t, delta_t):
        ...
        C_tp, w_tind, R_t_beta_1, R_t = self.proposal_epidemic.proposal_epidemic_t( t, theta, tildeC_tm1, Y_t, delta_t)
        ...
        return C_tp, A_t, log_p_y_t_given_y_1_to_tm1, R_t_beta_1, R_t
    ...
    def filter(self, Y, max_delta_t):
        ...
        return ancestors, infected, households, R_t_beta_1, R_t
