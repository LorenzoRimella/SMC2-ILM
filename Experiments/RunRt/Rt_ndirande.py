...
# Load the data
########################################################
n_individuals_ndirande          = np.load("Experiments/Data/Input/n_individuals_ndirande.npy")
n_households_ndirande           = np.load("Experiments/Data/Input/n_households_ndirande.npy")
households_longitude_ndirande   = np.load("Experiments/Data/Input/households_longitude_ndirande.npy")
households_latitude_ndirande    = np.load("Experiments/Data/Input/households_latitude_ndirande.npy")
loc_H_I_index_ndirande          = np.load("Experiments/Data/Input/loc_H_I_index_ndirande.npy")
individuals_covariates_ndirande = np.load("Experiments/Data/Input/individuals_covariates_ndirande.npy")

Y_ecoli_ndirande = np.load("Experiments/Data/Input/Y_ecoli_ndirande.npy")
Y_klebs_ndirande = np.load("Experiments/Data/Input/Y_kpneu_ndirande.npy")

theta_ndirande_ecoli   = np.load("Experiments/Data/Parameters/theta_best_ndirande_ecoli.npy") 
theta_ndirande_klebs   = np.load("Experiments/Data/Parameters/theta_best_ndirande_klebs.npy") 
...
file_name_ecoli = "ndirande_ecoli"     
file_name_klebs = "ndirande_klebs"   
